...
$info = [
    [
        'work_name' => 'Программист 1С',
        'work_date' => 'июль 2011 - май 2014',
        'work_descrip' => 'Работал программистом в ООО "Эльф"',
    ],
    [
        'work_name' => 'ИТ специалист',
        'work_date' => 'июль 2014 - до н.в.',
        'work_descrip' => 'Работаю ИТ специалистов в ООО "Капитал МС" в Республике Коми',
    ],
];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $info[$i]['work_date']?><span class="w3-tag w3-teal w3-round"></span></h6>
